    ...
    def Run(Directory: str = None, AnalyzeTimepoint: str = None, Model: str = None, Test: str = None, Graph: bool = False) -> tuple[list[FileInfo], pd.DataFrame]:
        ...
        if Model == 'Single Fibre':
            ...
            if Test == 'ktr':
                ...
                for File in All_Files:
                    if File.lower().__contains__('ktr'):
                        ...
                        # ktr analysis
                        Stiffness, ktr, GoodnessFit, Xmodel, Ymodel, ktrForce = AnalysisFunctions.ktrAnalysis(Data = Data, Graph = Graph)

                        ktrSpecificForce = ktrForce / CSA
                        # if GoodnessFit <= 0.95 and pCa == '4.5':
                        #     fig, ktrgraph = plt.subplots(figsize = (width:= 5, height:= 3), dpi = 100)
                        #     ktrgraph.plot(Data['Time'], Data['Force'], color = Black.Hex_Value)
            ...
            if Test == 'rFE':
                ...
                # rFE Analysis
                Data, PeakForce, PassiveForce, Stiffness = AnalysisFunctions.rFEAnalysis(Data = Data, Graph = Graph)
            ...
            if Test == 'Torque-Frequency':
                ...
                for File in All_Files:
                    if File.__contains__('TF'):
                        ...
                        PeakTorque = AnalysisFunctions.Torque_Frequency(Data = Data, Timepoint = Timepoint, Subject = Subject, Hz = Hz, Graph = Graph)
            ...
            if Test == 'Torque-Velocity-Power':
                ...
                for File in All_Files:
                    if File.__contains__('Isotonic'):
                        ...
                        ISO_Velocity, ISO_Torque, ContractionData = AnalysisFunctions.Torque_Velocity(Data = Data, Timepoint = Timepoint, ISO_Percent = ISO_Percent, Subject = Subject)
